...
#[test]
fn projects_round_trip_without_writing() {
...
#[test]
fn provider_sessions_report_ownership_and_explicit_resets() {
    nagoya::block_on(async {
...
#[test]
fn snapshot_session_audit_names_and_deduplicates_recovery_candidates() {
    nagoya::block_on(async {
...
#[test]
fn missing_store_reads_empty_and_creates_nothing() {
    nagoya::block_on(async {
...
/// reads it.
#[test]
fn reads_while_a_writer_holds_the_store() {
    nagoya::block_on(async {
