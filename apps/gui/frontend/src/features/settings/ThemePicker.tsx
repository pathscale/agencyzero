      ...
      <ComplexColorWheel
        ...
        action={
          <Button
            ...
            class="rounded-lg border border-az-hairline-strong px-2.5 py-1 text-az-strong text-ui-caption transition-colors hover:border-primary hover:text-primary disabled:cursor-not-allowed disabled:opacity-40"
          >
