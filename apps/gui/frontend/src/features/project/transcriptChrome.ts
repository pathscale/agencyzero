 ...
 * that change height, and they sit below `TranscriptPane` in the import graph.
 * Exporting this from the pane made the composer import the whole transcript to
 * say one word, and that import is what took the PR bar and the cost warning
 * off the screen.
 */
