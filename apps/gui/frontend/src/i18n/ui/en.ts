const en = {
  ...
  "checking the local endpoint": "checking the local endpoint",
  Connected: "Connected",
  ...
  "Confirm terminate & restart": "Confirm terminate & restart",
  ...
  "Open project {name}": "Open project {name}",
  "Open recent project {name}": "Open recent project {name}",
  "Open item {name}": "Open item {name}",
  "Rename project {name}": "Rename project {name}",
  "Delete project {name}": "Delete project {name}",
  "Collapse project {name}": "Collapse project {name}",
  "Expand project {name}": "Expand project {name}",
  conversation: "conversation",
  turn: "turn",
  tok: "tok",
  ...
  "Copied task-log entry": "Copied task-log entry",
  "Copy task log": "Copy task log",
  "Copied task log": "Copied task log",
  "Refresh AgencyProxy status": "Refresh AgencyProxy status",
  "AgencyProxy refresh generation {count}": "AgencyProxy refresh generation {count}",
  "Use bundled AgencyProxy": "Use bundled AgencyProxy",
  "Start AgencyProxy": "Start AgencyProxy",
  "Restart AgencyProxy": "Restart AgencyProxy",
  "Wait and restart AgencyProxy": "Wait and restart AgencyProxy",
  "Stop AgencyProxy": "Stop AgencyProxy",
  "Agent check generation {count}": "Agent check generation {count}",
  "Refresh analytics": "Refresh analytics",
  "Analytics refresh generation {count}": "Analytics refresh generation {count}",
  "Refresh provider usage": "Refresh provider usage",
  "Usage refresh generation {count}": "Usage refresh generation {count}",
  "Refresh performance measurements": "Refresh performance measurements",
  "Reset performance measurements": "Reset performance measurements",
  "Performance refresh generation {count}": "Performance refresh generation {count}",
  "Performance reset generation {count}": "Performance reset generation {count}",
  ...
  Processed: "Processed",
  "Billable traffic": "Billable traffic",
  "summed across model calls": "summed across model calls",
  "Usage records": "Usage records",
  "completed and reconstructed agent runs": "completed and reconstructed agent runs",
  "Largest agent run": "Largest agent run",
  "across model calls": "across model calls",
  ...
  "No unanswered question — work on this item": "No unanswered question — work on this item",
  "Work on {name}; it has no unanswered question": "Work on {name}; it has no unanswered question",
  "Reply to this item's question": "Reply to this item's question",
  "Reply to the question for {name}": "Reply to the question for {name}",
  ...
  "how far panels sit off the desk": "how far panels sit off the desk",
  ...
  "how far panels smear the app behind them; the window is blurred by macOS":
    "how far panels smear the app behind them; the window's own blur is macOS's",
  ...
  "{tables} tables, {references} references, read from {path}":
    "{tables} tables, {references} references, read from {path}",
  "Show all columns": "Show all columns",
  "Show key columns only": "Show key columns only",
  "All columns": "All columns",
  "Key columns": "Key columns",
  "Reset the diagram view": "Reset the diagram view",
  "Reset view": "Reset view",
  "WorkTable schema diagram": "WorkTable schema diagram",
  "Details for {table}": "Details for {table}",
  "Close table details": "Close table details",
  Columns: "Columns",
  Indexes: "Indexes",
  Queries: "Queries",
  ...
  "in place": "in place",
  delete: "delete",
  "{kind} by {column}": "{kind} by {column}",
  "declared in the overlay": "declared in the overlay",
  "inferred from naming": "inferred from naming",
  "faded line: often empty, never enforced": "faded line: often empty, never enforced",
  "drag to pan, scroll to zoom, click a table for detail":
    "drag to pan, scroll to zoom, click a table for detail",
