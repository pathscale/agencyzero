...
const zh = {
  ...
  "{tables} tables, {references} references, read from {path}":
    "{tables} 张表，{references} 处引用，读自 {path}",
  "Show all columns": "显示全部列",
  "Show key columns only": "仅显示关键列",
  "All columns": "全部列",
  "Key columns": "关键列",
  "Reset the diagram view": "重置图表视图",
  "Reset view": "重置视图",
  "WorkTable schema diagram": "WorkTable 结构图",
  "Details for {table}": "{table} 的详情",
  "Close table details": "关闭表详情",
  Columns: "列",
  Indexes: "索引",
  Queries: "查询",
  References: "引用",
  ...
  "in place": "原地",
  delete: "删除",
  "{kind} by {column}": "按 {column} {kind}",
  "declared in the overlay": "在覆盖文件中声明",
  "inferred from naming": "由命名推断",
  "faded line: often empty, never enforced": "淡线表示常为空，且从不强制",
  "drag to pan, scroll to zoom, click a table for detail": "拖动平移，滚动缩放，点击表查看详情",
  "+{count} more": "另有 {count} 项",
  "{name} on {column}": "{name} 建于 {column}",
  PK: "主键",
  UNIQUE: "唯一",
